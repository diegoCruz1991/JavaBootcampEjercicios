//1. Crear una clase que se llame Fecha para poder ingresar fechas en numeros enteros y que tenga un metodo que devuelva la fecha que se inserto en formato String
public class Fecha{
  ...
  class FechaNueva{
	...
	//3. El metodo para regresar la fecha seria:
    public boolean setFecha(int dia, int mes, int anio){
        this.dia = dia;
        this.mes = mes;
        this.anio = anio;

        //2. Aplicar encapsulacion y principio de ocultacion
