public class Problema {
	...
	public static void main(String... args) {
		...
		soloEmpleados[3] = new Entrenable();
		soloEmpleados[4] = new Programmer();
		soloEmpleados[5] = new Entrevistador();
		soloEmpleados[6] = new Reclutador();
		soloEmpleados[7] = new Programmer();
		soloEmpleados[8] = new Entrenable();
		soloEmpleados[9] = new Reclutador();
		
		for (int index = 0; i < soloEmpleados.length; i++) {
			if(soloEmpleados[index] instanceof Entrevistador;
			System.out.println("Tienes entrevista proximamente");
			if(soloEmpleados[index] instanceof Entrenable;
			System.out.println("Tienes entrevista proximamente");
			if(soloEmpleados[index] instanceof Programmer;
			System.out.println("Tienes entrevista proximamente");
		}
