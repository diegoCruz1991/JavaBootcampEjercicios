public class Problema {
	...
	public static void main(String... args) {
		...
		soloEmpleados[5] = new Reclutador();

		soloEmpleados[6] = new Programmer();

		soloEmpleados[7] = new Manager();

		soloEmpleados[8] = new Reclutador();

		soloEmpleados[9] = new Manager();

		//soloEmpleados[10] = new Programmer();
		...
		for (Empleado empleado : soloEmpleados){
			if(empleado instanceof Entrevistador){
				System.out.println("You have an Interview Coming soon ");
			}
			if(empleado instanceof Entrenable){
				System.out.println("You have training in 10 minutes");
			}
