mport java.time.temporal.Temporal;
...
public class Strings {
    ...
    public static void main (String... args) {
        ...
        Empleado empleado1 = obtenerEmpleado(" Jose | Eduardo | Valdez | Dominguez ");
        Empleado empleado2 = obtenerEmpleado(" Eduardo | Avila | Carranza ");
        Empleado empleado3 = obtenerEmpleado(" Eduardo | Avila ");
